Public Class AppuiTouche
    Private Sub AppuiTouche_Load(sender As Object, e As EventArgs)
    ...
    Private Sub ComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox1.SelectedIndexChanged
        ...
        Try
            ...
            'Dim picture4 As Image = Image.FromFile("I:\_sharediao\DIV\tooling_ass_oyk\uet_tooling_oyk\ORTAK\UET_MEKANIK\19-)Catalogue\BIBLIOTHEQUE_2020\101_REMONTAGE_std_RENAULT\E11_05000_GAUGE_APPUI_reference\3D_ep_20\5004_GAUGE_(20)x12_L55.jpg")
            'Dim picture5 As Image = Image.FromFile("I:\_sharediao\DIV\tooling_ass_oyk\uet_tooling_oyk\ORTAK\UET_MEKANIK\19-)Catalogue\BIBLIOTHEQUE_2020\101_REMONTAGE_std_RENAULT\E11_05000_GAUGE_APPUI_reference\3D_ep_20x20\5203_GAUGE(20)_20_L50.jpg")
            With Me.ComboBox2
            ...
            ElseIf ComboBox1.SelectedItem.ToString = "Nylon Gauge" Then
                ...
                Label1.Show()
                ComboBox3.Show()
            ElseIf ComboBox1.SelectedItem.ToString = "Gauge 20x12" Then
                Me.ComboBox2.Items.Add("15 [mm]")
                Me.ComboBox2.Items.Add("25 [mm]")
                Me.ComboBox2.Items.Add("35 [mm]")
                Me.ComboBox2.Items.Add("45 [mm]")
                Me.ComboBox2.Items.Add("55 [mm]")
                Label2.Show()
                ComboBox2.Show()
                Label1.Show()
                ComboBox3.Show()
            ElseIf ComboBox1.SelectedItem.ToString = "Gauge 20x20" Then
                Me.ComboBox2.Items.Add("20 [mm]")
                Me.ComboBox2.Items.Add("30 [mm]")
                Me.ComboBox2.Items.Add("40 [mm]")
                Me.ComboBox2.Items.Add("50 [mm]")
            ...
            With Me.ComboBox2
                ...
                ElseIf ComboBox1.SelectedItem = "Nylon Gauge" Then
                    ...
                    ElseIf ComboBox2.SelectedItem = "50 [mm]" Then
                        ...
                        Image1.Image = picture2
                    End If
                ElseIf ComboBox1.SelectedItem = "Gauge 20x12" Then
                    ''If ComboBox2.SelectedItem = "20 [mm]" Then
                    'Me.ComboBox3.Items.Add("8 [mm]")
                    '    Image1.Image = picture2
                    ''ElseIf ComboBox2.SelectedItem = "30 [mm]" Then
                ...
                ElseIf ComboBox1.SelectedItem = "Gauge 20x20" Then
                    'If ComboBox2.SelectedItem = "20 [mm]" Then
                    '    Me.ComboBox3.Items.Add("8 [mm]")
                    '    Image1.Image = picture2
                    'ElseIf ComboBox2.SelectedItem = "30 [mm]" Then
        ...
        With Me.ComboBox2
            ...
            ElseIf ComboBox1.SelectedItem = "Gauge 20x20" Then
                If ComboBox2.SelectedItem = "20 [mm]" Then
                    ...
                    CATIA = CreateObject("CATIA.Application")
                    CATIA.Visible = True
                    iPartDoc = CATIA.Documents.Open("I:\_sharediao\DIV\tooling_ass_oyk\uet_tooling_oyk\ORTAK\UET_MEKANIK\19-)Catalogue\BIBLIOTHEQUE_2020\101_REMONTAGE_std_RENAULT\E11_05000_GAUGE_APPUI_reference\3D_ep_20x20\5200_GAUGE(20)_20_L20.CATPart")
                ...
                ElseIf ComboBox2.SelectedItem = "30 [mm]" Then
                    ...
                    CATIA = CreateObject("CATIA.Application")
                    CATIA.Visible = True
                    iPartDoc = CATIA.Documents.Open("I:\_sharediao\DIV\tooling_ass_oyk\uet_tooling_oyk\ORTAK\UET_MEKANIK\19-)Catalogue\BIBLIOTHEQUE_2020\101_REMONTAGE_std_RENAULT\E11_05000_GAUGE_APPUI_reference\3D_ep_20x20\5201_GAUGE(20)_20_L30.CATPart")
                ...
                ElseIf ComboBox2.SelectedItem = "40 [mm]" Then
                    ...
                    CATIA = CreateObject("CATIA.Application")
                    CATIA.Visible = True
                    iPartDoc = CATIA.Documents.Open("I:\_sharediao\DIV\tooling_ass_oyk\uet_tooling_oyk\ORTAK\UET_MEKANIK\19-)Catalogue\BIBLIOTHEQUE_2020\101_REMONTAGE_std_RENAULT\E11_05000_GAUGE_APPUI_reference\3D_ep_20x20\5202_GAUGE(20)_20_L40.CATPart")
                ...
                ElseIf ComboBox2.SelectedItem = "50 [mm]" Then
                    ...
                    CATIA = CreateObject("CATIA.Application")
                    CATIA.Visible = True
                    iPartDoc = CATIA.Documents.Open("I:\_sharediao\DIV\tooling_ass_oyk\uet_tooling_oyk\ORTAK\UET_MEKANIK\19-)Catalogue\BIBLIOTHEQUE_2020\101_REMONTAGE_std_RENAULT\E11_05000_GAUGE_APPUI_reference\3D_ep_20x20\5203_GAUGE(20)_20_L50.CATPart")
                ...
                End If
            ElseIf ComboBox1.SelectedItem = "Gauge 20x12" Then
                If ComboBox2.SelectedItem = "15 [mm]" Then
                    'Get CATIA or Launch it if necessary.
                    On Error Resume Next
                    CATIA = GetObject(, "CATIA.Application")
                    ...
                    CATIA = CreateObject("CATIA.Application")
                    CATIA.Visible = True
                    iPartDoc = CATIA.Documents.Open("I:\_sharediao\DIV\tooling_ass_oyk\uet_tooling_oyk\ORTAK\UET_MEKANIK\19-)Catalogue\BIBLIOTHEQUE_2020\101_REMONTAGE_std_RENAULT\E11_05000_GAUGE_APPUI_reference\3D_ep_20\5000_GAUGE_(20)x12_L15.CATPart")

                    On Error GoTo 0
                ElseIf ComboBox2.SelectedItem = "25 [mm]" Then
                    'Get CATIA or Launch it if necessary.
                    On Error Resume Next
                    CATIA = GetObject(, "CATIA.Application")
                    ...
                    CATIA = CreateObject("CATIA.Application")
                    CATIA.Visible = True
                    iPartDoc = CATIA.Documents.Open("I:\_sharediao\DIV\tooling_ass_oyk\uet_tooling_oyk\ORTAK\UET_MEKANIK\19-)Catalogue\BIBLIOTHEQUE_2020\101_REMONTAGE_std_RENAULT\E11_05000_GAUGE_APPUI_reference\3D_ep_20\5001_GAUGE_(20)x12_L25.CATPart")

                    On Error GoTo 0
                ElseIf ComboBox2.SelectedItem = "35 [mm]" Then
                    'Get CATIA or Launch it if necessary.
                    On Error Resume Next
                    CATIA = GetObject(, "CATIA.Application")
                    ...
                    CATIA = CreateObject("CATIA.Application")
                    CATIA.Visible = True
                    iPartDoc = CATIA.Documents.Open("I:\_sharediao\DIV\tooling_ass_oyk\uet_tooling_oyk\ORTAK\UET_MEKANIK\19-)Catalogue\BIBLIOTHEQUE_2020\101_REMONTAGE_std_RENAULT\E11_05000_GAUGE_APPUI_reference\3D_ep_20\5002_GAUGE_(20)x12_L35.CATPart")

                    On Error GoTo 0
                ElseIf ComboBox2.SelectedItem = "45 [mm]" Then
                    'Get CATIA or Launch it if necessary.
                    On Error Resume Next
                    CATIA = GetObject(, "CATIA.Application")
                    ...
                    CATIA = CreateObject("CATIA.Application")
                    CATIA.Visible = True
                    iPartDoc = CATIA.Documents.Open("I:\_sharediao\DIV\tooling_ass_oyk\uet_tooling_oyk\ORTAK\UET_MEKANIK\19-)Catalogue\BIBLIOTHEQUE_2020\101_REMONTAGE_std_RENAULT\E11_05000_GAUGE_APPUI_reference\3D_ep_20\5003_GAUGE_(20)x12_L45.CATPart")

                    On Error GoTo 0
                ElseIf ComboBox2.SelectedItem = "55 [mm]" Then
                    'Get CATIA or Launch it if necessary.
                    On Error Resume Next
                    CATIA = GetObject(, "CATIA.Application")
                    ...
                    CATIA = CreateObject("CATIA.Application")
                    CATIA.Visible = True
                    iPartDoc = CATIA.Documents.Open("I:\_sharediao\DIV\tooling_ass_oyk\uet_tooling_oyk\ORTAK\UET_MEKANIK\19-)Catalogue\BIBLIOTHEQUE_2020\101_REMONTAGE_std_RENAULT\E11_05000_GAUGE_APPUI_reference\3D_ep_20\5004_GAUGE_(20)x12_L55.CATPart")
    ...
    Private Sub AppuiTouche_Load_1(sender As Object, e As EventArgs) Handles MyBase.Load
        ComboBox1.Items.Add("Gauge")
        ComboBox1.Items.Add("Gauge 20x12")
        ComboBox1.Items.Add("Gauge 20x20")
